...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>If you're looking for cars to rent near you, TVS car Rentals is your perfect solution, Select the vehicle of your choice from our wide range of cars Book & zoom away</p>
    </div>
    <div class="row"> 
...
<section class="fun-facts-section">
  <div class="container div_zindex">
    <div class="row">
      <div class="col-lg-3 col-xs-100 col-sm-3">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>777+</h2>
